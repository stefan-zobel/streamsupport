...
public class SliceOpTest extends OpTestCase {
    ...
    public void testSliceOpsSpliteratorPreservesSized() {
        Spliterator.OfInt parSpliterator = IntStreams.range(0, 1000).parallel().skip(50).limit(800).spliterator();
        ...
        Spliterator.OfInt seqSpliterator = IntStreams.range(0, 1000).skip(50).limit(800).spliterator();
