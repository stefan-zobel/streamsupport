...
public class LambdaTestHelpers {
    ...
    @SuppressWarnings("rawtypes")
    public static final Consumer bHashCode = x -> { java8.util.Objects.hashCode(x); };
    @SuppressWarnings("rawtypes")
    public static final BiConsumer bBiHashCode = (x,y) -> { java8.util.Objects.hash(x, y); };
    ...
    public static final Comparator<Integer> cInteger = (a, b) -> java8.lang.Integers.compare(a, b);
    ...
    public static<V, T, R> Function<V, R> compose(Function<? super T, ? extends R> after, Function<? super V, ? extends T> before) {
        java8.util.Objects.requireNonNull(before);
    ...
    public static<T> void assertSorted(Iterator<T> i, Comparator<? super T> comp) {
        if (i instanceof java8.util.PrimitiveIterator.OfInt
                || i instanceof java8.util.PrimitiveIterator.OfDouble
                || i instanceof java8.util.PrimitiveIterator.OfLong) {
            i = toBoxedList(i).iterator();
        }
    ...
    public static<T> void assertUnique(Iterator<T> iter) {
        ...
        if (iter instanceof java8.util.PrimitiveIterator.OfInt
            || iter instanceof java8.util.PrimitiveIterator.OfDouble
            || iter instanceof java8.util.PrimitiveIterator.OfLong) {
     ...
     * the boxing trip-wires.
     */
    public static<T> List<T> toBoxedList(java8.util.Spliterator<T> sp) {
        List<T> l = new ArrayList<>();
    ...
    @SuppressWarnings("unchecked")
    public static<T> Map<T, Integer> toBoxedMultiset(java8.util.Spliterator<T> it) {
        Map<Object, Integer> result = new HashMap<>();
