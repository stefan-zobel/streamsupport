...
final class DualPivotQuicksort {
     ...
     */
    static int[] mergeRuns(int[] a, int[] b, int offset,
     ...
     */
    static void mergeParts(Merger merger, int[] dst, int k,
...
// [long]
     ...
     * @return the destination where runs are merged
     */
    static long[] mergeRuns(long[] a, long[] b, int offset,
            int aim, boolean parallel, int[] run, int lo, int hi) {
     ...
     * @param hi2 the end index of the second part, exclusive
     */
    static void mergeParts(Merger merger, long[] dst, int k,
...
// [float]
     ...
     * @return the destination where runs are merged
     */
    static float[] mergeRuns(float[] a, float[] b, int offset,
            int aim, boolean parallel, int[] run, int lo, int hi) {
     ...
     * @param hi2 the end index of the second part, exclusive
     */
    static void mergeParts(Merger merger, float[] dst, int k,
...
// [double]
     ...
     * @return the destination where runs are merged
     */
    static double[] mergeRuns(double[] a, double[] b, int offset,
            int aim, boolean parallel, int[] run, int lo, int hi) {
     ...
     * @param hi2 the end index of the second part, exclusive
     */
    static void mergeParts(Merger merger, double[] dst, int k,
...
// [class]
    ...
    private static final class Sorter extends CountedCompleter<Void> {
        ...
        final Object a, b;
        final int low, size, offset, depth;

        Sorter(CountedCompleter<?> parent,
    ...
    private static final class Merger extends CountedCompleter<Void> {
        ...
        Merger(CountedCompleter<?> parent, Object dst, int k,
        ...
        void forkMerger(Object dst, int k,
                Object a1, int lo1, int hi1, Object a2, int lo2, int hi2) {
            addToPendingCount(1);
    ...
    private static final class RunMerger extends RecursiveTask<Object> {
        ...
        RunMerger(Object a, Object b, int offset,
