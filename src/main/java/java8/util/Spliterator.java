 ...
 * {@link Spliterator#tryAdvance(java8.util.function.Consumer)}
 * and {@link Spliterator#forEachRemaining(java8.util.function.Consumer)} box
 * primitive values to instances of their corresponding wrapper class.  Such
 * boxing may undermine any performance advantages gained by using the primitive
 * specializations.  To avoid boxing, the corresponding primitive-based methods
 * should be used.  For example,
 * {@link Spliterator.OfInt#tryAdvance(java8.util.function.IntConsumer)}
 * and {@link Spliterator.OfInt#forEachRemaining(java8.util.function.IntConsumer)}
 * should be used in preference to
 * {@link Spliterator.OfInt#tryAdvance(java8.util.function.Consumer)} and
 * {@link Spliterator.OfInt#forEachRemaining(java8.util.function.Consumer)}.
...
public interface Spliterator<T> {
     ...
     *
     * <p><b>API Note:</b><br> The characteristics of a given spliterator before splitting
     ...
     *
     * <p><b>API Note:</b><br> Encounter order is guaranteed to be ascending index order for
     ...
     * {@code ORDERED}.
     *
     * <p><b>API Note:</b><br> The spliterators for {@code Collection} classes in the JDK that
     ...
     *
     * <p><b>API Note:</b><br> Most Spliterators for Collections, that cover all elements of a
     ...
     *
     * <p><b>API Note:</b><br> Most concurrent collections maintain a consistency policy
     ...
     *
     * <p><b>API Note:</b><br> Some spliterators, such as the top-level spliterator for an
    ...
    public interface OfInt extends OfPrimitive<Integer, IntConsumer, OfInt> {
         ...
         * {@link #tryAdvance(java8.util.function.IntConsumer)}; otherwise
         * the action is adapted to an instance of {@code IntConsumer}, by
         * boxing the argument of {@code IntConsumer}, and then passed to
         * {@link #tryAdvance(java8.util.function.IntConsumer)}.
         */
        @Override
         ...
         * If the action is an instance of {@code IntConsumer} then it is cast
         * to {@code IntConsumer} and passed to
         * {@link #forEachRemaining(java8.util.function.IntConsumer)}; otherwise
         * the action is adapted to an instance of {@code IntConsumer}, by
         * boxing the argument of {@code IntConsumer}, and then passed to
         * {@link #forEachRemaining(java8.util.function.IntConsumer)}.
         */
        @Override
    ...
    public interface OfLong extends OfPrimitive<Long, LongConsumer, OfLong> {
         ...
         * {@link #tryAdvance(java8.util.function.LongConsumer)}; otherwise
         * the action is adapted to an instance of {@code LongConsumer}, by
         * boxing the argument of {@code LongConsumer}, and then passed to
         * {@link #tryAdvance(java8.util.function.LongConsumer)}.
         */
        @Override
         ...
         * If the action is an instance of {@code LongConsumer} then it is cast
         * to {@code LongConsumer} and passed to
         * {@link #forEachRemaining(java8.util.function.LongConsumer)}; otherwise
         * the action is adapted to an instance of {@code LongConsumer}, by
         * boxing the argument of {@code LongConsumer}, and then passed to
         * {@link #forEachRemaining(java8.util.function.LongConsumer)}.
         */
        @Override
    ...
    public interface OfDouble extends OfPrimitive<Double, DoubleConsumer, OfDouble> {
         ...
         * {@link #tryAdvance(java8.util.function.DoubleConsumer)}; otherwise
         * the action is adapted to an instance of {@code DoubleConsumer}, by
         * boxing the argument of {@code DoubleConsumer}, and then passed to
         * {@link #tryAdvance(java8.util.function.DoubleConsumer)}.
         */
        @Override
         ...
         * If the action is an instance of {@code DoubleConsumer} then it is
         * cast to {@code DoubleConsumer} and passed to
         * {@link #forEachRemaining(java8.util.function.DoubleConsumer)};
