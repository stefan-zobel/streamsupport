...
public interface Stream<T> extends BaseStream<T, Stream<T>> {
     ...
     * stream is {@link java8.util.stream.BaseStream#close() closed} after its
     ...
     * operation</a>.
     *
     * <p><b>API Note:</b><br> Sum, min, max, average, and string concatenation are all special
     ...
     * operation</a>.
     *
     * <p><b>API Note:</b><br> Many reductions using this form can be represented more simply
     ...
     * operation</a>.
     *
     * <p><b>API Note:</b><br> There are many existing classes in the JDK whose signatures are
