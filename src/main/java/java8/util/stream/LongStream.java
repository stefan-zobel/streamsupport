...
public interface LongStream extends BaseStream<Long, LongStream> {
     ...
     * @since 16
     */
    LongStream mapMulti(LongMapMultiConsumer mapper);
     ...
     * stream source (such as {@link LongStreams#generate(LongSupplier)}) or removing the
     ...
     * {@link LongStreams#generate(LongSupplier)}) or removing the ordering constraint with
