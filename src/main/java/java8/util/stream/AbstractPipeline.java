...
abstract class AbstractPipeline<E_IN, E_OUT, S extends BaseStream<E_OUT, S>>
    ...
    final <P_IN> long exactOutputSizeIfKnown(Spliterator<P_IN> spliterator) {
        ...
        if (size != -1L && StreamOpFlag.SIZE_ADJUSTING.isKnown(flags) && !isParallel()) {
     ...
     *
     * <p><b>Implementation Requirements:</b><br> The default implementation always throw
     ...
     *
     * <p><b>Implementation Requirements:</b><br> The default implementation behaves as if:
     * <pre>{@code
