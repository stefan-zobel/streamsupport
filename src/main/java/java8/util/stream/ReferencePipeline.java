...
abstract class ReferencePipeline<P_IN, P_OUT>
    ...
    @Override
    final <P_IN_> Node<P_OUT> evaluateToNode(PipelineHelper<P_OUT> helper,
                                        Spliterator<P_IN_> spliterator,
                                        boolean flattenTree,
    ...
    @Override
    final <P_IN_> Spliterator<P_OUT> wrap(PipelineHelper<P_OUT> ph,
                                     Supplier<Spliterator<P_IN_>> supplier,
                                     boolean isParallel) {
