 ...
 * derived from the equivalent {@link java8.util.Spliterator} characteristics:
 * {@link java8.util.Spliterator#DISTINCT}, {@link java8.util.Spliterator#SORTED},
 * {@link java8.util.Spliterator#ORDERED}, and
 * {@link java8.util.Spliterator#SIZED}.  A spliterator characteristics bit set
 * can be converted to stream flags using the method
 * {@link #fromCharacteristics(java8.util.Spliterator)} and converted back using
 ...
 * {@link java8.util.Spliterator#SUBSIZED} that information can be utilized to
